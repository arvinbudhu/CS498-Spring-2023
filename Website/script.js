...
const client_id = "AQESotPPeLSSDj4JKAdvFwFdQkq2TJCmSLgQ5NaoZDIksmsxiL5jT1iHtmp1PXLIpJB1NQbObYRYXQDc";
const currency = "USD";
...
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        createOrder: function(data, actions) { //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            return fetch("https://people.sunypoly.edu/~budhua/create_order", {
        ...
        onApprove: function(data, actions) {
            ...
            return fetch("https://people.sunypoly.edu/~budhua/complete_order", {
                method: "post", headers: { "Content-Type": "application/json; charset=utf-8" },
                body: JSON.stringify({
                    "intent": intent,
                    "order_id": order_id
